...
window.languageSet['zh']['icon-text-1'] = '你可以在鬼魂探测仪的帮助下搜寻隐藏的线索。';

window.languageSet['en']['icon-text-2'] = 'Snap a photo when the EMF indicator peaks.';
window.languageSet['zh']['icon-text-2'] = '在鬼魂探测仪达到峰值时进行抓拍。';
...
window.languageSet['zh']['intro-fail'] = '但历史还将重演。你还有一次机会去探寻邪灵真正的名字。';
...
window.languageSet['zh']['intro-share'] = '向朋友分享闯关成功的消息，即有机会赢取4张万圣节惊魂夜6的门票';
...
window.languageSet['zh']['code-instruction'] = '集齐 5 个代码方可解锁终极鬼屋';
